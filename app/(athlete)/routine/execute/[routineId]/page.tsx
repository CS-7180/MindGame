...
export default async function ExecuteRoutinePage({ params }: { params: { routineId: string } }) {
    ...
    if (error || !routine) {
        return (
            <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-950 flex flex-col items-center justify-center p-6 text-center text-slate-300">
